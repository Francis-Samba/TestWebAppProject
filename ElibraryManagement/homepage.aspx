        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p class="text-justify">Welcome to our book inventory. We've various categories that you can chose from</p>
                    <center>
                </div>
                <div class="col-md-4">
                    <center>
                        ...
                        <h4>Search Books</h4>
                    <p class="text-justify">Search for any book of your choice, we are here to help boost your reading urge.</p>
                    <center>
                </div>
                <div class="col-md-4">
                    <center>
                    ...
                    <p class="text-justify">All defaulters are required to comply with the laid down rules and regulations of the E-libary system.</p>
                    <center>
                </div>
